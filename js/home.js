...
langSelector.addEventListener("click", () => {
  ...
  if (language == "मराठी") {
    ...
    subheading2.innerHTML =
      "ऑफर्स व आकर्षक सवलती मिळतील! त्वरित आमच्या स्टॉलला भेट द्या! <br />१५ ऑक्टोबर ते २१ ऑक्टोबर <br />२४ तास उपलब्ध";
    addr.innerHTML =
  ...
  if (language == "English") {
    ...
    subheading2.innerHTML =
      "Offers and Discounts will be given! Be sure to visit our stall soon! <br />15<sup>th</sup> to 21<sup>st</sup> October <br />Open 24 hours";
    addr.innerHTML =
